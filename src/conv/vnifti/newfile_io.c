...
extern VAttrList Nifti1_to_Vista(char *databuffer,VLong tr,VBoolean);
...
VAttrList VReadAttrList(VString filename,VLong tr,VBoolean attrtype)
{
  VAttrList list = NULL;
  ...
  /* nifti format */
    ...
    list = Nifti1_to_Vista(databuffer,tr,attrtype);
  }
